...
# Category grouping lives in the GUI-neutral Utils.wizard_catalog (shared with
# the Qt Wizards menu); aliased to the old private names used below.
from Utils.wizard_catalog import (  # noqa: E402
    CATEGORY_ORDER,  # noqa: F401 — re-exported for existing importers
    group_by_category as _group_by_category,
    infer_category as _infer_category,  # noqa: F401
)
